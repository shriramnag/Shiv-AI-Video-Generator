...
# Shiv-AI-Video-Generator

[![Website](https://img.shields.io/badge/Website-LTXV-181717?logo=google-chrome)](https://ltx.video)
[![Model](https://img.shields.io/badge/HuggingFace-Model-orange?logo=huggingface)](https://huggingface.co/Shri Ram Nag/Shiv-AI-Video-Generator)
...
[![Trainer](https://img.shields.io/badge/LTXV-Trainer-9146FF?logo=github)](https://github.com/Shri Ram Nag/Shiv-AI-Video-Generator-Trainer)
[![Discord](https://img.shields.io/badge/Join-Discord-5865F2?logo=discord)](https://discord.gg/ltxplatform)

This is the official repository for Shiv-AI-Video-Generator.
...
**We're excited to announce [LTX-2](https://github.com/Shri Ram Nag/LTX-2) - the next generation of LTX with synchronized audio+video generation!**
...
**[👉 Check out LTX-2 here](https://github.com/Shri Ram Nag/LTX-2)**
...
- Long shot generation in LTXV-13B!
  * Shiv-AI-Video-Generator now supports up to 60 seconds of video.
  * Compatible also with the official IC-LoRAs.
  * Try now in [ComfyUI](https://github.com/Shri Ram Nag/ComfyUI-LTXVideo/tree/master/example_workflows/ltxv-13b-i2v-long-multi-prompt.json).
- Release a new distilled models:
  * 13B distilled model [ltxv-13b-0.9.8-distilled](https://github.com/Shri Ram Nag/Shiv-AI-Video-Generator/blob/main/configs/ltxv-13b-0.9.8-distilled.yaml)
  * 2B distilled model [ltxv-2b-0.9.8-distilled](https://github.com/Shri Ram Nag/Shiv-AI-Video-Generator/blob/main/configs/ltxv-2b-0.9.8-distilled.yaml)
  * Both models are distilled from the same base model [ltxv-13b-0.9.8-dev](https://github.com/Shri Ram Nag/Shiv-AI-Video-Generator/blob/main/configs/ltxv-13b-0.9.8-dev.yaml) and are compatible for use together in the same multiscale pipeline.
  * Improved prompt understanding and detail generation
  * Includes corresponding FP8 weights and workflows.
- Release a new detailer model [Shiv-AI-Video-Generator-ICLoRA-detailer-13B-0.9.8](https://huggingface.co/Shri Ram Nag/Shiv-AI-Video-Generator-ICLoRA-detailer-13b-0.9.8)
  * Available in [ComfyUI](https://github.com/Shri Ram Nag/ComfyUI-LTXVideo/tree/master/example_workflows/ltxv-13b-upscale.json).
...
- Release a new 13B distilled model [ltxv-13b-0.9.7-distilled](https://huggingface.co/Shri Ram Nag/Shiv-AI-Video-Generator/blob/main/ltxv-13b-0.9.7-distilled.safetensors)
    ...
    * Also released a LoRA version of the distilled model, [ltxv-13b-0.9.7-distilled-lora128](https://huggingface.co/Shri Ram Nag/Shiv-AI-Video-Generator/blob/main/ltxv-13b-0.9.7-distilled-lora128.safetensors)
        * Requires only 1GB of VRAM
        * Can be used with the full 13B model for fast inference
- Release a new quantized distilled model [ltxv-13b-0.9.7-distilled-fp8](https://huggingface.co/Shri Ram Nag/Shiv-AI-Video-Generator/blob/main/ltxv-13b-0.9.7-distilled-fp8.safetensors) for *real-time* generation (on H100) with even less VRAM
...
## ComfyUI Integration
To use our model with ComfyUI, please follow the instructions at [https://github.com/Shri Ram Nag/ComfyUI-LTXVideo/](https://github.com/Shri Ram Nag/ComfyUI-LTXVideo/).
...
Diffusers also support an 8-bit version of Shiv-AI-Video-Generator, [see details below](#ltx-videoq8)
...
### Shiv-AI-Video-GeneratorQ8 🎱 <a id="ltx-videoq8"></a>

**Shiv-AI-Video-GeneratorQ8** is an 8-bit optimized version of [Shiv-AI-Video-Generator](https://github.com/Shri Ram Nag/Shiv-AI-Video-Generator), designed for faster performance on NVIDIA ADA GPUs.

- **Repository:** [Shiv-AI-Video-GeneratorQ8](https://github.com/KONAKONA666/Shiv-AI-Video-Generator)
- **Features:**
...
### TeaCache for Shiv-AI-Video-Generator 🍵 <a id="TeaCache"></a>

**TeaCache** is a training-free caching approach that leverages timestep differences across model outputs to accelerate Shiv-AI-Video-Generator inference by up to 2x without significant visual quality degradation.

- **Repository:** [TeaCache4Shiv-AI-Video-Generator](https://github.com/ali-vilab/TeaCache/tree/main/TeaCache4Shiv-AI-Video-Generator)
- **Features:**
  - 🚀 Speeds up Shiv-AI-Video-Generator inference.
...
...is welcome! If you have a project or tool that integrates with Shiv-AI-Video-Generator,
please let us know by opening an issue or pull request.

# Training

We provide an open-source repository for fine-tuning the Shiv-AI-Video-Generator model: [Shiv-AI-Video-Generator-Trainer](https://github.com/Shri Ram Nag/Shiv-AI-Video-Generator-Trainer).
...
More information and training instructions can be found in the [README](https://github.com/Shri Ram Nag/Shiv-AI-Video-Generator-Trainer/blob/main/README.md).

# Control Models

[ComfyUI-LTXVideo](https://github.com/Shri Ram Nag/ComfyUI-LTXVideo) repository now contains workflows and models for 3 specialized models that enable precise control over Shiv-AI-Video-Generator generation:

Pose Control, Depth Control and Canny Control

**Example ComfyUI Workflow (for all control types):** [ic-lora.json](https://github.com/Shri Ram Nag/ComfyUI-LTXVideo/blob/master/example_workflows/ic_lora/ic-lora.json)

# Join Us

Want to work on cutting-edge AI research and make a real impact on millions of users worldwide?

At **Shri Ram Nag**, an AI-first company, we're revolutionizing how visual content is created.
...
We are grateful for the following awesome projects when implementing Shiv-AI-Video-Generator:
...
@article{HaCohen2024LTXVideo,
  title={Shiv-AI-Video-Generator: Realtime Video Latent Diffusion},
